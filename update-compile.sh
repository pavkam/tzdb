...
if [ "$?" -ne 0 ] || [ ! -e "$REPO/xx00" ] || [ ! -e "$REPO/xx01" ] || [ ! -e "$REPO/xx02" ]; then
    cleanup
...
echo -e "\n{ WARNING: This file is auto-generated by update-compile.sh. Do not edit it manually! }\nunit TZDB;" >> $TZDB_PAS_DIST
